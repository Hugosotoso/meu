...
export default function PatrimonioScreen() {
  ...
  const handleAbrirChamado = async () => {
    ...
    if (isDemoCpf(cpf)) {
      ...
      setDescricao('');
      setCarregando(false);
      Alert.alert('Demonstração', 'Chamado simulado. Nenhum dado foi enviado.');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footerFlutuante}>
        <View style={styles.footerResumo}>
          <Text style={styles.footerItensText}>Suporte do protótipo</Text>
          <Text style={styles.footerSubText}>Contato demonstrativo</Text>
        </View>
        <TouchableOpacity style={styles.btnContato} onPress={() => Alert.alert('Demonstração', 'Nenhuma ligação foi iniciada.')}>
