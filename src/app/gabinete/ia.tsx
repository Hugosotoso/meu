...
export default function GabineteIAScreen() {
  ...
  const exportarSEI = () => {
    Alert.alert("Sucesso", "Despacho sugerido exportado para a sua caixa de rascunhos no SEI!");
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroSub}>Deixe a IA ler processos extensos do SEI e sugerir despachos baseados na legislação vigente.</Text>
        </View>
        ...
        {etapa === 'upload' && (
          <TouchableOpacity style={styles.uploadBox} onPress={iniciarAnalise}>
            ...
            <Text style={styles.uploadTitle}>Toque para anexar Processo</Text>
            <Text style={styles.uploadSub}>Suporta PDF, DOCX ou link direto do SEI</Text>
          </TouchableOpacity>
        )}
        ...
        {etapa === 'analisando' && (
          <View style={styles.analisandoBox}>
            ...
            <Text style={styles.analisandoTitle}>A ler documento...</Text>
            <Text style={styles.analisandoSub}>Processando 142 páginas cruzando com a base de dados do TCU e Legislação Federal.</Text>
          </View>
        )}
        ...
        {etapa === 'resultado' && (
          <View style={styles.resultadoContainer}>
            ...
            <View style={styles.cardInfo}>
              ...
              <View style={styles.rowItem}>
                <MaterialIcons name="check-circle" size={18} color={GOV_COLORS.verde} />
                <Text style={styles.textVerde}>Certidão do INSS validada (Autêntica)</Text>
              </View>
            </View>
            ...
            <TouchableOpacity style={styles.btnAcao} onPress={exportarSEI}>
              <Text style={styles.btnAcaoTxt}>Exportar para o SEI</Text>
