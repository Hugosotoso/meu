      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.perfilCard}>
          ...
          <View style={{ flexDirection: 'row', gap: 15, marginTop: 4 }}>
            ...
            <Text style={styles.matriculaText}>Sessão demonstrativa</Text>
          </View>
        ...
        <View style={styles.serviceGroup}>
         <ServiceCard 
            ...
            color="#00BCD4" 
            onPress={() => router.push('/logistica/frota')}
          />
          <ServiceCard 
            icon="inventory" 
            title="Almoxarifado" 
            ...
            color="#FF9800" 
            onPress={() => router.push('/logistica/almoxarifado')}
          />
          <ServiceCard 
            icon="domain" 
            title="Patrimônio" 
            ...
            color="#9C27B0" 
           onPress={() => router.push('/logistica/patrimonio')}
          />
        </View>
