...
export default function AposentadoriaScreen() {
  ...
  const matricula = servidor?.matricula || 'Não informada';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Simulação Demonstrativa</Text>
        <View style={{ width: 34 }} />
      </View>

      <ScrollView style={{ flex: 1, padding: 16, marginBottom: 20 }}>
        <View style={styles.avisoDemo}>
          <MaterialIcons name="info-outline" size={18} color={GOV_COLORS.alertaTexto} />
          <Text style={styles.avisoDemoTexto}>Valores e datas são apenas exemplos acadêmicos. Não use esta tela para decisões previdenciárias.</Text>
        </View>
        ...
        <View style={styles.cardInfoGeral}>
          <View style={styles.infoRow}>
            ...
            <View style={{ flex: 1 }}>
            <Text style={styles.infoLabel}>Idade de exemplo</Text>
...
const styles = StyleSheet.create({
  ...
  avisoDemo: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: GOV_COLORS.alertaFundo, borderWidth: 1, borderColor: '#FDE68A', padding: 12, borderRadius: 10, marginBottom: 16 },
  avisoDemoTexto: { flex: 1, color: GOV_COLORS.alertaTexto, fontSize: 12, lineHeight: 18 },
